...
impl From<WasmRefType> for wasmedge::WasmEdge_RefType {
    fn from(ty: WasmRefType) -> Self {
        match ty {
            WasmRefType::FuncRef => wasmedge::WasmEdge_RefType_FuncRef,
            WasmRefType::ExternRef => wasmedge::WasmEdge_RefType_ExternRef,
        }
    }
}
...
impl From<WasmValueType> for wasmedge::WasmEdge_ValType {
    fn from(ty: WasmValueType) -> Self {
        match ty {
            WasmValueType::I32 => wasmedge::WasmEdge_ValType_I32,
            WasmValueType::I64 => wasmedge::WasmEdge_ValType_I64,
            WasmValueType::F32 => wasmedge::WasmEdge_ValType_F32,
            WasmValueType::F64 => wasmedge::WasmEdge_ValType_F64,
            WasmValueType::V128 => wasmedge::WasmEdge_ValType_V128,
            WasmValueType::FuncRef => wasmedge::WasmEdge_ValType_FuncRef,
            WasmValueType::ExternRef => wasmedge::WasmEdge_ValType_ExternRef,
            WasmValueType::None => wasmedge::WasmEdge_ValType_None,
        }
    }
}
impl From<wasmedge::WasmEdge_ValType> for WasmValueType {
    fn from(ty: wasmedge::WasmEdge_ValType) -> Self {
        match ty {
            wasmedge::WasmEdge_ValType_I32 => WasmValueType::I32,
            wasmedge::WasmEdge_ValType_I64 => WasmValueType::I64,
            wasmedge::WasmEdge_ValType_F32 => WasmValueType::F32,
            wasmedge::WasmEdge_ValType_F64 => WasmValueType::F64,
            wasmedge::WasmEdge_ValType_V128 => WasmValueType::V128,
            wasmedge::WasmEdge_ValType_FuncRef => WasmValueType::FuncRef,
            wasmedge::WasmEdge_ValType_ExternRef => WasmValueType::ExternRef,
            wasmedge::WasmEdge_ValType_None => WasmValueType::None,
